...
public class LOGIN_A extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("D:\\New folder (4)\\Library management Sustem\\im2.png")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jTextField1.getText().isEmpty()){
            JOptionPane.showMessageDialog(LOGIN_A.this, "Enter The Usename");
            jTextField1.grabFocus();
            return;
        }
        if(jPasswordField1.getText().isEmpty()){
            JOptionPane.showMessageDialog(LOGIN_A.this, "Enter The Password");
            jPasswordField1.grabFocus();
            return;
        }
        if(!"admin".equals(jTextField1.getText())){
            JOptionPane.showMessageDialog(LOGIN_A.this, "Invalid Usename");
            jTextField1.grabFocus();
            return;
        }
        if(!"admin".equals(jPasswordField1.getText())){
            JOptionPane.showMessageDialog(LOGIN_A.this, "Invalid Password");
            jPasswordField1.grabFocus();
            return;
        }
        if ("admin".equals(jTextField1.getText()) && "admin".equals(jPasswordField1.getText())) {

            admin_p1 p = new admin_p1();
            p.setVisible(true);
